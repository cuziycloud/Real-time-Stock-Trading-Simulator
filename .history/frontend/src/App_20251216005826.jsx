  ...
  const columns = [
    {
      ...
      dataIndex: 'symbol',
      key: 'symbol',
      render: (text) => <Tag color="blue" style={{fontSize: 16}}>{text}</Tag> //chinh sua cach hien thi
    },
    {
      ...
      key: 'price',
      render: (price) => {
        return <Text strong style={{fontSize: 16}, {textAlign = 'center'}}>{price.toFixed(2)}</Text>
      }
    },
    {
      title: 'Bien dong',
